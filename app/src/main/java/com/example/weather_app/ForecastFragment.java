...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String,Void,String[]> {
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            final String OWNN_TEMPERATURE = "temp";
            ...
            JSONArray jobArray = forecastJson.getJSONArray(OWN_LIST);
            ...
            for (int i=0; i<jobArray.length();i++){
                ...
                JSONObject dayForecast = jobArray.getJSONObject(i);
                ...
                JSONObject temperatureObject = dayForecast.getJSONObject(OWNN_TEMPERATURE);
